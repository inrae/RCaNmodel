...
>>>>>>> 733d73d (Rajout de la version word du materiel supplementaire)
# Introduction
...
>>>>>>> 735a4db (Rajout du materiel supplementaire.)
...
RCaN requires R (version 3.2+) to be installed. 
...
>>>>>>> 735a4db (Rajout du materiel supplementaire.)
=======
#    "https://github.com/inrae/RCaN.git",
#    subdir="RCaN",
#    dependencies = TRUE)
>>>>>>> 56237aa (edit rmd paper)
#  }
```
...
>>>>>>> 735a4db (Rajout du materiel supplementaire.)
=======
The RCaN function *sampleCaN* is used to sample of the polytope, i.e. to sample several random possible trajectories of the food-web dynamics. The output of this command is a mcmc.list object (defined in package coda). The function parameters include:
>>>>>>> 56237aa (edit rmd paper)
...
gelman.diag(SAMPLE$mcmc[,c(fluxZ1,fluxZ2,fluxZ3,fluxZ4)],
            multivariate = FALSE)
=======
gelman.diag(SAMPLE$mcmc[,c(fluxZ1,fluxZ2,fluxZ3,fluxZ4)], multivariate = FALSE)
>>>>>>> 735a4db (Rajout du materiel supplementaire.)
=======
gelman.diag(SAMPLE$mcmc[,c(fluxZ1,fluxZ2,fluxZ3,fluxZ4)],
            multivariate = FALSE)
...
ggSeries(SAMPLE, POLYTOPE$species, TRUE) +
  ...
  facet_grid(cols=POLYTOPE$species)
#dev.off()
<<<<<<< HEAD
```
...
=======
pdf("GGseriesComponents.pdf")
ggSeries(SAMPLE, POLYTOPE$species, TRUE) + theme(legend.position = "none") + facet_grid(cols=POLYTOPE$species)
dev.off()
```
...
=======
pdf("GGseriesFluxes.pdf")
ggSeries(SAMPLE, POLYTOPE$flow, TRUE) + theme(legend.position = "none") 
dev.off()
>>>>>>> 735a4db (Rajout du materiel supplementaire.)
=======
>>>>>>> 56237aa (edit rmd paper)
...
=======
pdf("ViolinsFluxes.pdf")
ggViolin(SAMPLE,POLYTOPE$flow,year=1990,TRUE) +   xlab('Component') + ylab('Biomass') +  theme(axis.text.x=element_text(angle=90))
dev.off();
>>>>>>> 735a4db (Rajout du materiel supplementaire.)
=======
>>>>>>> 56237aa (edit rmd paper)
...
g <- ggTopDownBottomUp(SAMPLE, 
                       species=list(Ozoo=c("DemF","PelF"), 
                                    DemF=c("MM"))) 
=======
g <- ggTopDownBottomUp(SAMPLE, species=list(Ozoo=c("DemF","PelF"), DemF=c("MM"))) 
>>>>>>> 735a4db (Rajout du materiel supplementaire.)
=======
g <- ggTopDownBottomUp(SAMPLE, 
                       species=list(Ozoo=c("DemF","PelF"), 
