...
// ---------------------------------
    final SimpleStringProperty date = new SimpleStringProperty(),
        whichTimeLine = new SimpleStringProperty(),
        commentAuthor = new SimpleStringProperty();
    ...
    private void setDate(String date) {this.date.set(date);}
    public String getWhichTimeLines() {return whichTimeLine.get();}
    public StringProperty whichTimeLineProperty() {return whichTimeLine;}
    public void setWhichTimeLines(String whichTimeLine) {this.whichTimeLine.set(whichTimeLine);}
    public String getCommentAuthor() {return commentAuthor.get();}
    public StringProperty commentAuthorProperty() {
        return commentAuthor;
    }
    public void setCommentAuthor(String commentAuthor) {this.commentAuthor.set(commentAuthor);}
    public void print(){
