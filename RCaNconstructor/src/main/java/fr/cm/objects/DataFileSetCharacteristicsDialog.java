...
public class DataFileSetCharacteristicsDialog extends Dialog <ButtonType> {
    ...
    public DataFileSetCharacteristicsDialog(DataFile selectedDataFile){
        ...
        if(selectedDataFile != null) {
            ...
            if(selectedDataFile.isCorrectlyRead()){
