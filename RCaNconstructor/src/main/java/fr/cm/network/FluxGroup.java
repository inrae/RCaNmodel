...
public class FluxGroup extends Group {
    ...
    private Path getArrow() {
        ...
        left.xProperty().bind(mX.add(new fr.cm.network.FluxGroup.CosBinding(new fr.cm.network.FluxGroup.ArcTanBinding(dx, dY).add(Math.PI + Math.PI / 4)).multiply(ARROW_LENGTH)));
        left.yProperty().bind(mY.add(new fr.cm.network.FluxGroup.SinBinding(new fr.cm.network.FluxGroup.ArcTanBinding(dx, dY).add(Math.PI + Math.PI / 4)).multiply(ARROW_LENGTH)));
        ...
        right.xProperty().bind(mX.add(new fr.cm.network.FluxGroup.CosBinding(new fr.cm.network.FluxGroup.ArcTanBinding(dx, dY).add(Math.PI - Math.PI / 4)).multiply(ARROW_LENGTH)));
        right.yProperty().bind(mY.add(new fr.cm.network.FluxGroup.SinBinding(new fr.cm.network.FluxGroup.ArcTanBinding(dx, dY).add(Math.PI - Math.PI / 4)).multiply(ARROW_LENGTH)));

        LineTo re = new LineTo();
        re.xProperty().bind(mX.add(new fr.cm.network.FluxGroup.CosBinding(new fr.cm.network.FluxGroup.ArcTanBinding(dx, dY).add(Math.PI + Math.PI / 4)).multiply(ARROW_LENGTH)));
        re.yProperty().bind(mY.add(new fr.cm.network.FluxGroup.SinBinding(new fr.cm.network.FluxGroup.ArcTanBinding(dx, dY).add(Math.PI + Math.PI / 4)).multiply(ARROW_LENGTH)));
