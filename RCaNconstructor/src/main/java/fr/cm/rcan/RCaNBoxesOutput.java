...
public class RCaNBoxesOutput {
    ...
    static HBox RCaNBox(String txt){
        ...
        // outputR.setPrefSize(500, 500);
        ScrollPane scrollOutputR;
        scrollOutputR = new ScrollPane(outputR);
        double cw = 0.9 * Context.getWidth();
        double ch = 0.9 * Context.getHeight();
    ...
    static File file;
    static Image imageR = null;
    // ------------------------------------------------------------------------
    static HBox RCaNBox(File file){
        RCaNBoxesOutput.file = file;
        ImageView viewR = new ImageView();
        imageR = new Image(file.toURI().toString());
