 ...
 */
public class ConstraintNewOrEdit extends Dialog<ButtonType> {
    ...
    public ConstraintNewOrEdit(Constraint constraint) {
    ...
    void initDialog(){
        ...
        namesComponents.addAll(ListsManager.getNamesOfComponents());
        ...
        namesLinks.addAll(ListsManager.getNamesOfLinks());
        ...
        namesObservations.addAll(ListsManager.getNamesOfObservations());
    ...
    final void addEditConstraint() {
        if (formula.check().equals("Ok")) {
            if(editCst){
                Constraint constraint =  new Constraint(cstNameTextArea.getText(),formula.getFormula(), labelTokenYears.getText(), true, "");
                ListsManager.updateConstraint(previousConstraint, constraint);
            }
            else {
                Constraint constraint = new Constraint(cstNameTextArea.getText(),formula.getFormula(), labelTokenYears.getText(), true, "");
