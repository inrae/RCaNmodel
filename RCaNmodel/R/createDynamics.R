...
createDynamics <- function(dynamics_equation = NULL,
  ...
  matrices <- lapply(seq_len(nrow(series)),
                     function(y) {
                       ...
                       list(H = H, N = N, Nend = Nend)
                     })
  H = do.call(list, lapply(matrices, function(m) m$H))
  N = do.call(list, lapply(matrices, function(m) m$N))
  Nend = do.call(list, lapply(matrices, function(m) m$Nend))
