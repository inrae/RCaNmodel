...
#'
#' @details Following \insertCite{planque2022;textual}{RCaNmodel}, this function
#' estimates satiation based on an allometric relationship formulated by
#' \insertCite{yodzis1992;textual}{RCaNmodel} or
#' \insertCite{savage2004;textual}{RCaNmodel}
#'
