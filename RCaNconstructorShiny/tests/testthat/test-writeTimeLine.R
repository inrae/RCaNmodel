test_that("writeTimeLine works", {
  ...
  expect_equal(writeTimeLine("metaobs", 
                             ...
                             data.frame(id = "toto", 
                                        ...
                                        Comment = "blabla2")),
               tibble::tibble(Task = "observation Serieold renamed to Serienewseries Serienew Comment changed blabla2 -> blabla"))
})
