...
#'
#' @return a data frame with first column as names of params and 2 columns for bounds
#' @export
#'
...
getAllBoundsParamCaNmod <- function(myCaNmod) {
  getAllBoundsParam(as.matrix(myCaNmod$A),myCaNmod$b,as.matrix(myCaNmod$C),myCaNmod$v)
}
