...
sampleCaNCPP <- function(N, A, b, C, v, L, x0, thin, gibbs = TRUE, algo = 1L, seed = 1L, stream = 1L, covMat = NULL) {
    .Call(`_RCaN_sampleCaNCPP`, N, A, b, C, v, L, x0, thin, gibbs, algo, seed, stream, covMat)
}
