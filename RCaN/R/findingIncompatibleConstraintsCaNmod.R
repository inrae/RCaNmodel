...
#' @export
#'
#' @importFrom cpgsR findingIncompatibleConstraints
#'
#' @examples
...
#' findingIncompatibleConstraintsCaNmod(myCaNmod)



findingIncompatibleConstraintsCaNmod <- function(myCaNmod) {
  findingIncompatibleConstraints(as.matrix(myCaNmod$A),
                                 myCaNmod$b,
