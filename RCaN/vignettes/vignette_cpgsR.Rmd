...
vignette: >
  %\VignetteIndexEntry{vignette_cpgsR}
...
* \code{\link{chebycenter}}: a function to compute the centroid of the polytope that can be used as inital point of the sampler
