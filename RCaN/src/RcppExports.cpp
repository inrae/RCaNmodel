...
// fitCaN
List fitCaN(const int N, const Eigen::MatrixXd& A, const Eigen::VectorXd& b, const Eigen::MatrixXd& C, const Eigen::VectorXd& v, const Eigen::MatrixXd& L, const Eigen::VectorXd M, const Eigen::VectorXd& x0, const int thin);
RcppExport SEXP _RCaN_fitCaN(SEXP NSEXP, SEXP ASEXP, SEXP bSEXP, SEXP CSEXP, SEXP vSEXP, SEXP LSEXP, SEXP MSEXP, SEXP x0SEXP, SEXP thinSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(fitCaN(N, A, b, C, v, L, M, x0, thin));
