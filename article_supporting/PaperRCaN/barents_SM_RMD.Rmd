...
The RCaN-file, constructed with RCaNconstructor and the R-Markdown file, used to generate this supplementary material can be found on [github](https://github.com/inrae/RCaN/blob/master/article_supporting/PaperRCaN). In that folder, an hmtl version of this document is also available, pn which tables are more complete and interactive tables.
...
ggPairsBiomass(samples,c("Benthos","PelF","DemF"),
               logscale=FALSE, frac = .25) + #we only 25% of the point 
