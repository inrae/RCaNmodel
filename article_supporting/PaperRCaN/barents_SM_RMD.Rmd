...
The RCaN-file, constructed with RCaNconstructor and the R-Markdown file, used to generate this supplementary material can be found on [github](https://github.com/inrae/RCaN/blob/master/article_supporting/PaperRCaN). 
